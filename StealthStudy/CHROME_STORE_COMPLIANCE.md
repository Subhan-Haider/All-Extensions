# Chrome Web Store Compliance: StealthStudy

## 1. Single Purpose
**Description:**
A stealthy utility tool for students to manage their browsing environment privately.

*Justification:*
The single purpose of **StealthStudy** is to a stealthy utility tool for students to manage their browsing environment privately directly within the browser. All features and permissions are strictly scoped to support this purpose.
...
### scripting
Required to inject content scripts that modify the page (e.g., blocking elements, changing styles) as per StealthStudy's core function.
